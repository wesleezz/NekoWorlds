...
export default function Home() {
  return (
    <>
      <Head>
        <title>Ресурпак › Вики · NekoWorlds</title>
        <meta
          name="description"
        ...
        <meta property="og:title" content="Ресурпак › Вики" />
        <meta
                ...
                <div className="prose prose-zinc dark:prose-invert prose-img:rounded-lg prose-headings:font-manrope prose-code:text-teal-600 dark:prose-code:text-teal-500 prose-pre:my-0 prose-pre:bg-transparent prose-pre:p-0 prose-pre:text-zinc-800 dark:prose-pre:text-zinc-200 prose-a:underline-offset-2 prose-a:transition prose-a:text-teal-600 prose-a:decoration-teal-300/50 hover:prose-a:text-teal-700 hover:prose-a:decoration-teal-400/50 dark:prose-a:text-teal-500 dark:prose-a:decoration-teal-700/50 dark:hover:prose-a:text-teal-300 dark:hover:prose-a:decoration-teal-500/50 max-w-full [&_li_p]:my-0">
                  <article>
                    <p className="text-zinc-700 dark:text-zinc-200">
                      Интересная механика на нашем сервере
                    </p>
                    <h3
                      id="how-to"
                    ...
                    <ul className="mb-5 mt-5 gap-2 px-0">
                      <li className="mb-2 text-zinc-700 dark:text-zinc-200">
                        для начала зажмите клавишу shift
                      </li>
                      <li className="text-zinc-700 dark:text-zinc-200">
                        далее кликнете ПКМ по рамке с ножницами в руках
                      </li>
                    </ul>
                    <h3
                      id="rp"
                    ...
                    <div className="not-prose grid grid-flow-col justify-start">
                      <button
                        className="ring-black/15 dark:ring-white/15 dark:hover:bg-zinc-250 grid cursor-not-allowed select-none grid-flow-col items-center justify-center gap-2 rounded-lg bg-zinc-100 px-4 py-2 font-medium text-zinc-900 outline-zinc-700 ring-1 ring-inset transition hover:bg-zinc-200 focus-visible:outline-dashed focus-visible:outline-2 focus-visible:outline-offset-2 active:bg-zinc-300 dark:bg-zinc-700 dark:text-zinc-100 dark:active:bg-zinc-600"
                        aria-disabled="false"
                      >
                        <p>Загрузка пока что недоступна</p>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
                    ...
                    <ul>
                      <li>
                        <a
                          ...
                          href="#how-to"
                        >
                          <div className="col-start-2">Как установить?</div>
                        </a>
                      </li>
                      <li>
                        <a
                          ...
                          href="#rp"
                        >
                          <div className="col-start-2">Ресурспак</div>
                        </a>
                      </li>
                    </ul>
                  </nav>
